...
from winapi.kernel32.processthreadsapi import open_process_rw
from winapi.kernel32.handleapi import close_handle
from winapi.kernel32.processthreadsapi import open_thread_ctx_rw
from winapi.kernel32.processthreadsapi import get_thread_context
from winapi.kernel32.processthreadsapi import set_thread_context
from winapi.kernel32.processthreadsapi import is_thread_suspended
from winapi.kernel32.processthreadsapi import suspend_thread
from winapi.kernel32.processthreadsapi import resume_thread
from winapi.kernel32.processthreadsapi import get_thread_cip
from winapi.kernel32.processthreadsapi import set_thread_cip
from winapi.kernel32.tlhelp32 import get_main_thread_id
from winapi.kernel32.processthreadsapi import create_process_suspended
from winapi.kernel32.wow64apiset import is_wow64_process
from winapi.kernel32.libloaderapi import get_library_address
from winapi.kernel32.memoryapi import allocate_rw_memory
from winapi.kernel32.memoryapi import allocate_rwx_memory
from winapi.kernel32.memoryapi import write_memory
from winapi.kernel32.memoryapi import set_memory_protect_ro
from winapi.kernel32.memoryapi import set_memory_protect_x
...
def get_lla_address_external(proc_name):
    wow64_getaddress_exe = os.path.join(os.path.dirname(os.path.realpath(__file__)),"get_k32_address_WOW64.exe")
    output = subprocess.Popen([wow64_getaddress_exe,proc_name], stdout=subprocess.PIPE).communicate()[0].decode("ascii")
